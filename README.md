...
- Added multi channel support but will not work for old links generated by the bot.
...
* `DBCHANNELS` Your Database Channel seperated with spaces eg:- -100xxxxxxxx
...
* `START_MSG` Optional: start message of bot, use HTML
* `FORCE_MSG`Optional:Force sub message of bot, use HTML and Fillings
